...
<figure data-mobile-shot="phone"><a href="../assets/mobile/iphone-conversation.webp"><img src="../assets/mobile/iphone-conversation.webp" alt="Cherry Studio 移动版 iPhone 对话界面"></a><figcaption><p><strong>iPhone</strong> · 完整对话与消息操作，点击查看原图</p></figcaption></figure>
<figure data-mobile-shot="tablet"><a href="../assets/mobile/ipad-conversation.webp"><img src="../assets/mobile/ipad-conversation.webp" alt="Cherry Studio 移动版 iPad 对话界面"></a><figcaption><p><strong>iPad</strong> · 针对平板空间展开的对话界面，点击查看原图</p></figcaption></figure>
</div>
