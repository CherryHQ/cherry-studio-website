...
1. **查找支援 API 的模型**  
   ...
   ![API 模型篩選](../../../../assets/e74196f9b0677f509232b2a7.webp)  
...
2. **獲取模型 ID**  
   ...
   ![複製 Model ID](../../../../assets/b280b347b848c9336100c083.webp)  
3. **填入 Cherry Studio**  
...
- 登入 ModelScope → 點擊右上角 **`用戶名`** → **`API 使用情況`**  
  ![額度查看位置](../../../../assets/cf9952cb6a67762a088ade28.webp)  
