...
| **Bailian (阿裡百鍊)** | Qwen 系列、有海量模型 | [bailian.console.aliyun.com](https://bailian.console.aliyun.com/) | [→](aliyun-bailian.md) |
...
如果您使用的服務不在上述清單中，但提供 **OpenAI 相容 / Anthropic 相容 / Gemini 相容** 任一協定，都可以透過 [自訂服務商](custom-provider.md) 新增。
