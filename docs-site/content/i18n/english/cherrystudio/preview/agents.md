...
{% hint style="info" %}
The button in the upper right corner of the prompt input box is the AI prompt optimization button. Clicking it will overwrite the original text. The model used is the [Global Default Assistant Model](../../pre-basic/settings/default-models.md).
{% endhint %}