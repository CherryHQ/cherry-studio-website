...
| Quick Assistant | [Quick Assistant](../quick-assistant.md) | A global floating mini chat window |
| Selection Assistant | [Selection Assistant](../selection-assistant.md) | Instant translate / explain / rewrite for selected text |
