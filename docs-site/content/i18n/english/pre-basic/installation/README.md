...
First, download the installer that matches your operating system and chip from the [official download page](https://cherryai.com/download/v2).
...
If Cherry Studio opens normally, the client is installed. Next, continue with Quick Start to configure a model service and send your first message.
