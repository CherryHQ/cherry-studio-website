...
2.  Click the `Create My API-KEY` button in the top right corner.
    <figure><img src="../../../../assets/00b4cbef8a9bbea93bb4a9b6.webp" alt=""><figcaption>Creating an API Key for Alibaba Cloud Bailian</figcaption></figure>
...
3.  In the pop-up window, select the default business space (or you can customize it), and you can fill in a description if you wish.
    <figure><img src="../../../../assets/5d1d415f32559b716089d8c1.webp" alt=""><figcaption>Create API Key Pop-up Window for Alibaba Cloud Bailian</figcaption></figure>
...
5.  Afterward, you should see a new row added to the list. Click the `View` button on the right.
    <figure><img src="../../../../assets/89f7665003a1634b74bedd69.webp" alt=""><figcaption>Viewing the API Key for Alibaba Cloud Bailian</figcaption></figure>
