...
1. **Log in to the Platform**
   ...
   ![Login interface](../../../../assets/81ab1f79d9eb105d47adeb7c.webp)
2. **Create Access Token**
   ...
   ![New token example](../../../../assets/183749676e4437e61ed9168f.webp)
...
- Paste the copied token into the `API Key` field
  ![Configuration interface](../../../../assets/6c187aa7fa2ce14286cce6e6.webp)
...
1. **Find API-supported Models**
   ...
   ![API model filtering](../../../../assets/e74196f9b0677f509232b2a7.webp)
...
2. **Obtain Model ID**
   ...
   ![Copy Model ID](../../../../assets/b280b347b848c9336100c083.webp)
3. **Enter into Cherry Studio**
   ...
   ![Enter Model ID](../../../../assets/a5685729023ae084554989bd.webp)
...
- Log in to ModelScope → Click **`Username`** in the top right corner → **`API Usage`**
  ![Quota viewing location](../../../../assets/cf9952cb6a67762a088ade28.webp)
