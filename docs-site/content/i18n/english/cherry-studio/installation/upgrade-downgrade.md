...
## V2.0.2 Upgrade and Migration

{% hint style="warning" %}
If you need to retain V1 data, the correct path is: **V1.9.13 → V2.0.2 (direct data migration)**. You no longer need to install V2.0.0 first.
{% endhint %}

| Current Situation | Recommended Action |
| --------------- | ------------------------------------ |
| Still on V1, need to retain data | Update V1 to 1.9.13, then directly install V2.0.2 to complete migration. |
| Already using V2 | Upgrade to V2.0.2 normally and continue using current V2 data; do not click [Re-migrate]. |
