...
## Mise à niveau et migration vers V2

{% hint style="warning" %}
Si vous devez conserver les données V1, la procédure correcte est : **V1.9.13 → V2 (migration des données directe)**. Il n'est pas nécessaire d'installer d'abord une version intermédiaire particulière de V2.
{% endhint %}

| Situation actuelle | Action à entreprendre |
| --------------- | ------------------------------------ |
| Toujours sur V1, besoin de conserver les données | Mettre à jour V1 vers 1.9.13, puis installer directement V2 pour finaliser la migration. |
| Déjà sur V2 | Mettre à niveau vers V2 normalement et continuer à utiliser les données V2 actuelles ; ne pas cliquer sur [Réimporter]. |
