...
## Расширенное руководство <a href="#advanced-basic" id="advanced-basic"></a>
...
* [Обновление и откат версии](question-contact/version-switching.md)
...
* [Открытая лицензия Cherry Studio](contact-us/questions/license.md)
