...
- ✅ **Бесплатная квота**: ежедневно предоставляется **2000 бесплатных вызовов API** ([Правила тарификации](#правила-тарификации-и-квот))
...
1. **Вход на платформу**
   ...
   ![Иллюстрация](../../../../assets/81ab1f79d9eb105d47adeb7c.webp)
2. **Создание токена доступа**
   ...
   ![Иллюстрация](../../../../assets/183749676e4437e61ed9168f.webp)
...
- В поле `API ключ` вставьте скопированный токен
  ![Иллюстрация](../../../../assets/6c187aa7fa2ce14286cce6e6.webp)
...
1. **Поиск моделей с поддержкой API**
   ...
   ![Иллюстрация](../../../../assets/e74196f9b0677f509232b2a7.webp)
...
2. **Получение ID модели**
   ...
   ![Иллюстрация](../../../../assets/b280b347b848c9336100c083.webp)
3. **Ввод в Cherry Studio**
   ...
   ![Иллюстрация](../../../../assets/a5685729023ae084554989bd.webp)
...
- Войдите в ModelScope → нажмите на **`имя пользователя`** в правом верхнем углу → выберите **`Использование API`**
  ![Иллюстрация](../../../../assets/cf9952cb6a67762a088ade28.webp)
