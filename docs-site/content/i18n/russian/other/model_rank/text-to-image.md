# Рейтинг моделей для генерации изображений по тексту

На этой странице представлены ежедневные снимки топ-30 моделей из рейтинга [Arena AI](https://arena.ai/leaderboard/text-to-image), что позволяет быстро оценить их недавние результаты. Полный рейтинг, фильтры и последние изменения доступны на официальном сайте Arena AI.

В данном рейтинге оценивается способность моделей генерировать изображения по текстовым запросам.

> **Время обновления данных**: 2026-09-19 12:14:58 UTC / 2026-09-19 20:14:58 CST (по пекинскому времени)

{% hint style="info" %}
Рейтинг отражает результаты конкретных тестов и предпочтения пользователей в голосовании, но не гарантирует, что модель будет лучше работать именно в ваших задачах. При выборе модели также учитывайте стоимость, скорость, размер контекста, возможность вызова инструментов, конфиденциальность и доступность в вашем регионе.
{% endhint %}

## Топ-30

|   Ранг | Диапазон ранга | Модель                                                                                                                                                                             | Очки                     |      Голоса |
|-----:|:-------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------|--------:|
|    1 | 1-2    | gpt-image-2.5-sunburst [<sup>1</sup>](https://openai.com/index/introducing-chatgpt-images-2-5/)                                                                                | 1421 (±13) Предварительные |   3,149 |
|    2 | 1-2    | gpt-image-2.5-flare [<sup>1</sup>](https://openai.com/index/introducing-chatgpt-images-2-5/)                                                                                   | 1399 (±13) Предварительные |   2,856 |
...
|    5 | 4-6    | grok-imagine-image-2.0 (low) [<sup>1</sup>](https://x.ai/news/grok-imagine-image-2)                                                                                            | 1315 (±12) Предварительные |   2,681 |
...
* **Ранг / Диапазон ранга**: относительное место, оценённое Arena AI на основе голосований в битвах «текст в изображение»; диапазон ранга отражает колебания позиции в пределах доверительного интервала.
* **Очки**: относительная оценка, удобная для сравнения моделей в рейтинге на один и тот же момент времени.
* **Голоса**: ориентир по объёму выборки; при малом количестве образцов ранг обычно более подвержен колебаниям.
...
Данные взяты из [официального рейтинга «текст в изображение» Arena AI](https://arena.ai/leaderboard/text-to-image) и обновляются ежедневно через GitHub Actions. Цены, лицензии и возможности моделей следует уточнять по официальным данным провайдера.
