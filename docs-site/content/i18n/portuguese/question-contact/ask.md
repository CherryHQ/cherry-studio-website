...
# Métodos Eficientes de Perguntar
...
* Dúvidas sobre funcionalidades e uso do software podem ser encontradas na documentação de [Funcionalidades](../cherrystudio/preview/);
* Perguntas frequentes estão compiladas na página [FAQ](questions.md) - verifique primeiro se há soluções lá;
...
* Consulte ou pesquise problemas semelhantes e soluções na página de [Issues](https://github.com/CherryHQ/cherry-studio/issues) do GitHub.
...
* Pedir ajuda nos canais oficiais: [Telegram](https://t.me/CherryStudioAI), [Discord](https://discord.com/invite/wez8HtpxqQ) ou [Grupo QQ[^1]](https://qm.qq.com/cgi-bin/qm/qr?authKey=xe5nfGVZLMYnlJq%2F%2B4kN03YWcDBB2lnD7tc9rWus2mxS0JHUbOzk79cO7MYuqyGR\&k=UKVgl3YPHmwPaU8qeO1VG03NcUkACKsc\&noverify=0).
...
1. **Para erros de modelo:** 
   ...
   * Método para ver erros do console: [clique aqui](questions.md#kong-zhi-tai-bao-cuo-cha-kan-fang-fa).

2. **Para bugs de software:**
   * Descreva o erro **concretamente** e forneça etapas detalhadas de **[reprodução[^2]](#user-content-fn-2)**.
...
Contate `@Wangmouuu` no Telegram, QQ (`1355873789`) ou email: `sunrise@cherry-ai.com`.
{% endhint %}

[^1]: Número do grupo: 611659451
[^2]: Quando o erro se repete