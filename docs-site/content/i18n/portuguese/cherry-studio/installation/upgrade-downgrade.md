...
## Atualização e Migração para V2.0.2

{% hint style="warning" %}
Se for necessário reter os dados do V1, o caminho correto é: **V1.9.13 → V2.0.2 (conclusão direta da migração de dados)**. Não é mais necessário instalar o V2.0.0 primeiro.
{% endhint %}

| Situação atual | O que deve ser feito |
| --------------- | ------------------------------------ |
| Ainda no V1, com necessidade de reter dados | Atualize o V1 para a versão 1.9.13 e, em seguida, instale diretamente o V2.0.2 para concluir a migração. |
| Já está usando o V2 | Atualize normalmente para o V2.0.2 e continue usando os dados atuais do V2; não clique em [Migrar novamente]. |
