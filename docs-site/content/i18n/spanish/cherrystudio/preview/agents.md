...
{% hint style="info" %}
El botón en la esquina superior derecha del cuadro de entrada de prompts es para optimizar el prompt con IA. Al hacer clic, sobrescribirá el texto original. El modelo utilizado es el [asistente predeterminado global](../../pre-basic/settings/default-models.md).
{% endhint %}