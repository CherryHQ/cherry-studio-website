...
Esta página muestra una instantánea diaria de los 30 primeros puestos del ranking de [Arena AI](https://arena.ai/leaderboard/vision), para facilitar la comprensión rápida del rendimiento reciente de los modelos. Para ver el ranking completo, las opciones de filtrado y los cambios más recientes, visite el sitio web oficial de Arena AI.

Este ranking evalúa el rendimiento de los modelos multimodales en tareas de comprensión de imágenes.

> **Fecha de actualización de los datos**: 2026-09-19 12:14:58 UTC / 2026-09-19 20:14:58 CST (hora de Beijing)

{% hint style="info" %}
El ranking refleja preferencias específicas de evaluación y votación de usuarios, y no equivale a que un modelo sea necesariamente mejor para su tarea. Al elegir un modelo, también debe considerar el precio, la velocidad, el contexto, la invocación de herramientas, la privacidad y la disponibilidad regional.
{% endhint %}
...
Los datos provienen de la [Clasificación oficial de visión de Arena AI](https://arena.ai/leaderboard/vision) y se actualizan diariamente mediante GitHub Actions. Para los precios, licencias y capacidades de los modelos, consulta la información oficial del proveedor del modelo.
