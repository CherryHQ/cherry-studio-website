...
3. **Cherry Studioに入力**
   ...
   ![説明画像](../../../../assets/a5685729023ae084554989bd.webp)
...
- ModelScopeにログイン → 右上 **`ユーザー名`** → **`API使用状況`**をクリック
  ![説明画像](../../../../assets/cf9952cb6a67762a088ade28.webp)
